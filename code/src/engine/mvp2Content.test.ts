  ...
  describe('MVP2_STAGE_ENEMIES (§9.2)', () => {
    ...
    it('map 4 stage enemies match exponential curve with pyRound', () => {
      ...
      expect(map4Enemies).toEqual([
        { map: 4, stage: 1, name: '蜀道游匪', hp: 300, atk: 50.0, def: 40.0, hit: 152, dodge: 20, tags: [], kind: 'normal', recommendedRealm: 5 },
        { map: 4, stage: 2, name: '飞檐夜盗', hp: 348, atk: 52.5, def: 43.2, hit: 154, dodge: 50, tags: ['高闪'], kind: 'normal', recommendedRealm: 5 },
        { map: 4, stage: 3, name: '五毒教徒', hp: 525, atk: 55.1, def: 46.7, hit: 156, dodge: 20, tags: ['毒'], kind: 'elite', recommendedRealm: 5 },
        { map: 4, stage: 4, name: '落草刀客', hp: 468, atk: 57.9, def: 50.4, hit: 158, dodge: 20, tags: [], kind: 'normal', recommendedRealm: 5 },
        { map: 4, stage: 5, name: '铁壁甲士', hp: 543, atk: 60.8, def: 82, hit: 160, dodge: 20, tags: ['高防'], kind: 'normal', recommendedRealm: 5 },
        { map: 4, stage: 6, name: '毒蛊婆', hp: 819, atk: 63.8, def: 58.8, hit: 162, dodge: 20, tags: ['毒'], kind: 'elite', recommendedRealm: 5 },
        { map: 4, stage: 7, name: '蜀道游匪', hp: 731, atk: 67.0, def: 63.5, hit: 164, dodge: 20, tags: [], kind: 'normal', recommendedRealm: 5 },
        { map: 4, stage: 8, name: '五毒长老', hp: 1102, atk: 70.4, def: 68.6, hit: 166, dodge: 20, tags: ['毒'], kind: 'elite', recommendedRealm: 5 },
        { map: 4, stage: 9, name: '铁壁甲士', hp: 984, atk: 73.9, def: 111, hit: 168, dodge: 20, tags: ['高防'], kind: 'normal', recommendedRealm: 5 },
      ]);
    });
    ...
    it('map 5 stage enemies match exponential curve with pyRound', () => {
      ...
      expect(map5Enemies).toEqual([
        { map: 5, stage: 1, name: '绝谷游魂', hp: 800, atk: 100.0, def: 80.0, hit: 167, dodge: 25, tags: [], kind: 'normal', recommendedRealm: 6 },
        { map: 5, stage: 2, name: '铁布衫客', hp: 1277, atk: 104.0, def: 84.8, hit: 169, dodge: 25, tags: ['反伤'], kind: 'elite', recommendedRealm: 6 },
        { map: 5, stage: 3, name: '净心武者', hp: 1040, atk: 108.2, def: 89.9, hit: 171, dodge: 25, tags: ['净化'], kind: 'normal', recommendedRealm: 6 },
        { map: 5, stage: 4, name: '狂刀客', hp: 1185, atk: 146.2, def: 95.3, hit: 173, dodge: 25, tags: ['高攻'], kind: 'normal', recommendedRealm: 6 },
        { map: 5, stage: 5, name: '金钟罩僧', hp: 1891, atk: 117.0, def: 101.0, hit: 175, dodge: 25, tags: ['反伤'], kind: 'elite', recommendedRealm: 6 },
        { map: 5, stage: 6, name: '绝谷游魂', hp: 1540, atk: 121.7, def: 107.1, hit: 177, dodge: 25, tags: [], kind: 'normal', recommendedRealm: 6 },
        { map: 5, stage: 7, name: '铁布衫客', hp: 2458, atk: 126.5, def: 113.5, hit: 179, dodge: 25, tags: ['反伤'], kind: 'elite', recommendedRealm: 6 },
        { map: 5, stage: 8, name: '狂刀客', hp: 2002, atk: 171.1, def: 120.3, hit: 181, dodge: 25, tags: ['高攻'], kind: 'normal', recommendedRealm: 6 },
        { map: 5, stage: 9, name: '金钟罩僧', hp: 3195, atk: 136.9, def: 127.5, hit: 183, dodge: 25, tags: ['反伤'], kind: 'elite', recommendedRealm: 6 },
      ]);
    });
  });
