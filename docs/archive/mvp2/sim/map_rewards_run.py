...
if __name__ == "__main__":
    for mr in MAP_REWARDS:
        print(f"Map {mr.map_id}: {mr.stages} stages, elites at {mr.elite_stages}")
        print(f"  Normal:  {mr.normal.neili} / {mr.normal.silver} / {mr.normal.yueli}")
        print(f"  Elite:   {mr.elite.neili} / {mr.elite.silver} / {mr.elite.yueli}")
        print(f"  Total:   {mr.pre_boss_total.neili} / {mr.pre_boss_total.silver} / {mr.pre_boss_total.yueli}")
        print()
